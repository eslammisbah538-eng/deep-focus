...
function renderAIHelp() {
    ...
    if (urgentSub && daysUntil(urgentSub.examDate) === 0) {
        ...
        sug2 = `لسه مبدأتش النهارده، أبدأ إزاي؟`;
    } else if (weekly.activeDays < 2 && weekly.pomodoroCount === 0) {
...
- ممنوع الرد على أي سؤال مالوش علاقة بالمذاكرة/التطبيق (سياسة، دين، إلخ) — رد بلطف إنك مساعد دراسي بس وارجع للموضوع
